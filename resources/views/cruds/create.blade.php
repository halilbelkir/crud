        ...
        <div class="card p-0">
            ...
            <div class="card-body py-4 form row justify-content-center fv-plugins-bootstrap5 fv-plugins-framework">
                ...
                <div class="form-group col-12 col-md-6 mb-7 fv-plugins-icon-container">
                    ...
                    <textarea name="content" cols="30" rows="7" placeholder="Açıklama" class="form-control form-control-solid mb-3 mb-lg-0"></textarea>
                </div>
                ...
                <div class="form-group col-12 col-md-6 mb-7 fv-plugins-icon-container">
                    ...
                    <textarea id="other_route" name="other_route" data-json="true" rows="2" class="form-control form-control-solid">{}</textarea>
