@extends('crudPackage::layout.main',['activePage' => ' Modüller'])
@section('content')
    <div class="card">
...
@section('datatables.ajax.url'){{route('cruds.datatables')}}@stop
@section('datatables.files.title') Modüller @stop
